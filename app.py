...
def create_avg_alcohol_by_class_plot():
    chart_filename = charts.create_avg_alcohol_by_class_plot(app)
    return send_from_directory('static', 'images/chart1.png')


@app.route('/correlation_matrix')
def create_correlation_chart():
    chart_filename = charts.create_correlation_chart(app)
    return send_from_directory('static', 'images/correlation_matrix.png')
